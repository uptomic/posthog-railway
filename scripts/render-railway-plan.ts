  ...
  services: {
    ...
    "Cymbal Resolution": {
      ...
      environment: {
        ...
        OBJECT_STORAGE_ACCESS_KEY_ID: "${{Web.OBJECT_STORAGE_ACCESS_KEY_ID}}",
        OBJECT_STORAGE_SECRET_ACCESS_KEY: "${{Web.OBJECT_STORAGE_SECRET_ACCESS_KEY}}",
    ...
    Cymbal: {
      ...
      environment: {
        ...
        PORT: "3305",
        DATABASE_URL: "${{Web.DATABASE_URL}}",
        KAFKA_HOSTS: "${{posthog-ingestion.KAFKA_HOSTS}}",
        KAFKA_TLS: "false",
        ISSUE_BUCKETS_REDIS_URL: "${{Web.REDIS_URL}}",
        OBJECT_STORAGE_BUCKET: "${{Web.OBJECT_STORAGE_BUCKET}}",
        OBJECT_STORAGE_ENDPOINT: "${{Web.OBJECT_STORAGE_ENDPOINT}}",
        OBJECT_STORAGE_REGION: "${{Web.OBJECT_STORAGE_REGION}}",
        OBJECT_STORAGE_ACCESS_KEY_ID: "${{Web.OBJECT_STORAGE_ACCESS_KEY_ID}}",
